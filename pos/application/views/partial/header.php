...
<head>
	...
	<title><?php echo $this->config->item('company') . ' | ' . $this->lang->line('common_powered_by') . ' DPOS ' . $this->config->item('application_version') ?></title>
	...
	<?php else : ?>
		...
		<link rel="stylesheet" type="text/css" href="dist/opensourcepos.min.css?rel=291511c951" />
		...
		<script type="text/javascript" src="dist/opensourcepos.min.js?rel=ccc740593f"></script>
	...
	<style type="text/css">
		...
		#receipt_items{font-size:12px !important;font-weight: bold !important;}
		#receipt_items .items-name{font-size:20px !important;font-weight: bold !important;}
	</style>
</head>
		...
		<div class="navbar navbar-default" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand hidden-sm" href="<?php echo site_url(); ?>">DPOS</a>
				</div>
